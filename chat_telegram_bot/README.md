...
- **ارتباط با ادمین:** قابلیت ارسال مستقیم پیام به ادمین ربات برای پشتیبانی.
...
- **مدیریت عضویت اجباری (قفل کانال):**
  - **پاسخ به کاربران:** قابلیت پاسخ مستقیم به پیام‌هایی که کاربران برای ادمین ارسال می‌کنند.
...
- **Contact Admin:** Ability to send a direct message to the bot admin for support.
...
- **Force Subscription Management:**
  - **Reply to Users:** Ability to directly reply to messages sent by users to the admin.
